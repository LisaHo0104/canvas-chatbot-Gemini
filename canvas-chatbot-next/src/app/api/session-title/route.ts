        ...
        parts: [
          {
            type: 'text',
            text:
              'Generate a concise conversation title (4–8 words) that captures the main topic of this first exchange. Use Title Case, avoid punctuation, avoid generic phrases like "Chat" or "Conversation". Return ONLY JSON that matches the schema.',
          },
        ],
      },
    ]
