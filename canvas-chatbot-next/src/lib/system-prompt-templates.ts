...
// Flashcard Generation focused prompt
const FLASHCARD_GENERATION_PROMPT = `${BASE_PROMPT}
...
export const SYSTEM_PROMPT_TEMPLATES: SystemPromptTemplate[] = [
  ...
  {
    name: 'Flashcard Mode',
    description: 'Focused on generating flashcards (question/answer or term/definition pairs) from course materials for study and review',
    template_type: 'flashcard_generation',
    prompt_text: FLASHCARD_GENERATION_PROMPT,
  },
];
